...
def loginuser(request):
    if request.method == 'GET':
        ...
        user = authenticate(request, username=request.POST['username'], #значения в квадратных скобках берутся из свойств элементов на страничке(F12)
...
#@login_required - декоратор не позволяющий незарегистрованным пользователям ходить по ссылкам в адресной строке
@login_required
